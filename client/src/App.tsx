      ...
      <Box display="flex" flexDirection="column" gap="medium">
        ...
        <Box display="flex" gap="small">
          <Button
            ...
            disabled={!erpUrl.trim() || !erpToken.trim()}
          >
            💾 Salvar
          </Button>
            ...
            {syncHistory.map((operation) => (
              ...
              >
                <Box display="flex" justifyContent="space-between" alignItems="center">
                  ...
                  <Text fontSize="caption" color={operation.status === 'completed' ? 'success' : operation.status === 'pending' ? 'warning' : 'danger'}>
                    {operation.status}
                  </Text>
                </Box>
  ...
  return (
    <Box padding="large" backgroundColor="neutral">
      ...
      <Box display="flex" gap="small" marginBottom="large">
        ...
        <Button
          variant={currentView === 'sync' ? 'primary' : 'secondary'}
          onClick={() => setCurrentView('sync')}
        >
          🔄 Sincronização
        </Button>
        <Button
          variant={currentView === 'status' ? 'primary' : 'secondary'}
